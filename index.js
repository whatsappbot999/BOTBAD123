...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=994408324449:+994 40 832 4449\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["994408324449@s.whatsapp.net"] 
...
client.updatePresence(from, Presence.composing) 
          ...
          case 'logoph':
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('994408324449@s.whatsapp.net', options, text, {quoted: mek})
