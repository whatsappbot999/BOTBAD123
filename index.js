...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=13312450562:+1 (331) 245-0562\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["13312450562@s.whatsapp.net"] 
...
client.updatePresence(from, Presence.composing) 
          ...
          case 'logoph':
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('13312450562@s.whatsapp.net', options, text, {quoted: mek})
